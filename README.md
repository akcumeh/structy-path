...
|  | [005-is-prime](#005---is-prime) | [py](./py/00-introduction/005-is-prime.py) / [js](./js/00-introduction/005-is-prime.js) |
| [01 - Arrays & Strings](#01---arrays--strings) | [009-anagrams](#009---anagrams) | [py](./py/01-arrays-and-strings/009-anagrams.py) / [js](./js/01-arrays-and-strings/009-anagrams.js) |
|  | [010-most-freq-char](#010---most-frequent-char) | [py](./py/01-arrays-and-strings/010-most-freq-char.py) / [js](./js/01-arrays-and-strings/010-most-freq-char.js) | 
|  | [011-pair-sum](#011---pair-sum) | [py](./py/01-arrays-and-strings/011-pair-sum.py) / [js](./js/01-arrays-and-strings/011-pair-sum.js) | 
|  | [012-pair-product](#012---pair-product) | [py](./py/01-arrays-and-strings/012-pair-product.py) / [js](./js/01-arrays-and-strings/012-pair-product.js) | 
|  | [013-uncompress](#013---uncompress) | [py](./py/01-arrays-and-strings/013-uncompress.py) / [js](./js/01-arrays-and-strings/013-uncompress.js) | 
|  | [014-compress](#014---compress) | [py](./py/01-arrays-and-strings/014-compress.py) / [js](./js/01-arrays-and-strings/014-compress.js) | 
| [02 - Beginner Recursion]() | [023-sum-numbers-recursive](#023---sum-numbers-recursive) | [py](./py/02-beginner-recursion/023-sum-numbers-recursive.py) / [js](./js/02-beginner-recursion/023-sum-numbers-recursive.js) | 
...
### [005 - is prime](https://structy.net/problems/is-prime)
#### Problem
...
#### Solutions
[Solution - py](./py/00-introduction/005-is-prime.py)
![All Testcases Passed](./assets/005-is-prime.py.png)
...
#### Solutions
[Solution - py](./py/01-arrays-and-strings/009-anagrams.py)
![All Testcases Passed - py](./assets/009-anagrams.py.png)

[Solution - js](./js/01-arrays-and-strings/009-anagrams.js)
![All Testcases Passed - js](./assets/009-anagrams.js.png)
...
#### Solutions
[Solution - py](./py/01-arrays-and-strings/010-most-freq-char.py)
![All Testcases Passed - py](./assets/010-most-freq-char.py.png)

[Solution - js](./js/01-arrays-and-strings/010-most-freq-char.js)
...
#### Solutions
[Solution - py](./py/01-arrays-and-strings/011-pair-sum.py)
![All Testcases Passed](./assets/011-pair-sum.py.png)

[Solution - js](./js/01-arrays-and-strings/011-pair-sum.js)
...
#### Solutions
[Solution - py](./py/01-arrays-and-strings/012-pair-product.py)
![All Testcases Passed](./assets/012-pair-product.py.png)

[Solution - js](./js/01-arrays-and-strings/012-pair-product.js)
...
#### Solutions
[Solution - py](./py/01-arrays-and-strings/013-uncompress.py)
...
#### Solutions(es?)
[Solution - py](./py/01-arrays-and-strings/014-compress.py)
